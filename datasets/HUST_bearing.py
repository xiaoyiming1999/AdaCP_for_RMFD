...
class_name = {0: 'B6', 1: 'I6',  2: 'IB6', 3: 'IO6', 4: 'N6', 5: 'O6', 6: 'OB6'}

work_condition = ['00', '02', '04']
...
class HUST_data_split(object):
    ...
    def data_split(self):
        list_train_data = data_load(root=r'D:\datasets\HUST\HUST bearing dataset',
        ...
        list_val_data = data_load(root=r'D:\datasets\HUST\HUST bearing dataset',
                              conditions=self.op_conditions,
                              SNR=self.noise_SNR,
                              num_train_samples=self.num_train_samples,
                              num_val_samples=self.num_val_samples,
        ...
        list_test_data = data_load(root=r'D:\datasets\HUST\HUST bearing dataset',
                              conditions=self.op_conditions,
                              SNR=self.noise_SNR,
                              num_train_samples=self.num_train_samples,
                              num_val_samples=self.num_val_samples,
